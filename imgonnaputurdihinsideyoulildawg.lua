...
local RandomPossibleMessages = {"Enjoy using this script! 😃", "Enjoy using this script sigma ✅✅!"}
...
local chain = Window:CreateTab("[🟢] Chain", 4483362458)
local guns = Window:CreateTab("[🟢] Weapons", 4483362458)
local Dev;
...
local UhhhRemoveBL = OP:CreateButton({
    Name = "[🟢] Remove Warehouse Blacklist",
    Callback = function()
        local s, e = pcall(function()
...
local CrucifixBlatant2 = OP:CreateButton({
    Name = "[🟢] Blatant Spam Use Crucifix",
    Callback = function()
        if not debug.getupvalues or not getsenv then
        ...
        local args = {
            "CrucifixBegin",
            [3] = "223c0949-8704-468c-ae11-58e30129355d"
        }
        game:GetService("Players").LocalPlayer.Character:WaitForChild("CharacterHandler"):WaitForChild("Contents"):WaitForChild("Remotes"):WaitForChild("Interact"):FireServer(unpack(args))
...
local DBInstaBmTHING = Main:CreateButton({
    Name = "[🟢] Insta Blood Moon [Requires DB]",
    Callback = function()
        function Main()
            local args = {
                        [1] = {
...
local SBT = OP:CreateButton({
    Name = "[🟢] Spoof Placed BT", -- Explanation: Can place more than max beartrap in 1 night
    Callback = function()
